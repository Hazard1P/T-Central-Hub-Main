...
const PRIMARY_WORLD_NODES = [
  { key: 'sbox', label: 'S&Box', address: 'sbox.game', description: 'External S&Box route.', position: [2.8, 11.2, -4.2], color: '#7cd6ff', route: 'https://sbox.game/', external: true, kind: 'blackhole', priority: 7, foundationBuilt: true },
  { key: 'matrixcoinexchange', label: 'MatrixCoinExchange', address: 'matrixcoinexchange.com', description: 'External MatrixCoinExchange route.', position: [8.6, 6.4, -3.0], color: '#6dffb5', route: 'https://matrixcoinexchange.com', external: true, kind: 'blackhole', priority: 8, tags: ['exchange', 'settlement', 'scalar gains'], foundationBuilt: true },
  ...
  { key: 'deep_blackhole', label: 'Deep Space Blackhole', address: 'Primary deep-space anchor', description: 'Deep-space blackhole generated procedurally so the map and anchorage are computed from the shared universe engine instead of static artwork.', position: [-17.2, -3.6, -5.8], color: '#c4d4ff', kind: 'blackhole', priority: 6, tags: ['deep space', 'map anchor', 'existing anchorage'], foundationBuilt: true },
  { key: 'csis', label: 'CSIS Dyson Sphere', address: 'Game defense / foundation core', description: 'CSIS Dyson sphere with a first ring that spins as a network linkage lattice and a second ring that spins as a defensive firewall for foundation-built system space. The sphere is system-owned, sealed to player construction, and reserved for game defense only.', position: [-6.8, 10.6, 5.8], color: '#8ff3ff', kind: 'dyson', priority: 7, tags: ['network linkage', 'firewall ring', 'foundation core', 'sealed defense'], dysonProfile: 'csis', foundationBuilt: true, networkRole: 'foundation-security', systemOwned: true, playerInteractive: false, playerBuildable: false, requestSurface: false, routeSurface: 'sealed' },
  { key: 'ss', label: 'S.S Dyson Sphere', address: 'Primary spinning sphere', description: 'S.S Dyson sphere with maintained spinning segments and a nearby docking station for ship recovery, sortie launch, and return staging.', position: [13.8, -1.4, 6.0], color: '#ffd67d', kind: 'dyson', priority: 8, tags: ['spinning segments', 'dock proximity', 'ship recovery'], dysonProfile: 'ss', foundationBuilt: true },
  { key: 'ss_dock', label: 'S.S Docking Station', address: 'Docking lane / hangar ring', description: 'Primary ship docking station stationed in proximity to the S.S Dyson Sphere for launch, return, and mission turn-in.', position: [16.95, -0.15, 7.45], color: '#9fe6ff', kind: 'node', priority: 8, tags: ['docking', 'hangar', 'proximity station'], structureProfile: 'docking_station', foundationBuilt: true },
