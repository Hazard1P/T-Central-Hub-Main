...
const PRIMARY_WORLD_NODES = [
  ...
  { key: 'standalone_blackhole', label: '<(BlackHole)> Standalone', address: 'Relative server anchorage core', description: 'Standalone <(BlackHole)> anchor for the cosmic map. It carries relative server anchorage, blackhole data storage, entropic storage, star-node routing, Dyson sphere handoff, and fabric-of-the-universe relativity continuity for autonomous monitoring.', position: [-2.4, 8.8, -10.4], color: '#9eb6ff', kind: 'blackhole', priority: 11, tags: ['standalone blackhole', 'relative anchorage', 'data storage', 'entropic storage', 'star nodes', 'dyson handoff', 'universe fabric relativity'], foundationBuilt: true, networkRole: 'standalone-intelligence-anchor' },
