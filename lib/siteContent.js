...
export const FLIGHT_CONTROL_COPY = {
  desktopSummary: 'WASD / arrows',
  verticalSummary: 'Space / Shift',
  boostSummary: 'Control',
  touchSummary: 'flight pad',
  launchPrimer:
    'Desktop: WASD / arrows to fly nose-forward, Space / Shift to climb and dive, hold Control to boost. Mobile: use the flight pad.',
  fullSummary:
    'Controls: WASD / arrows to fly nose-forward, Space / Shift to climb and dive, hold Control to boost, tap Q to fire, and keep the active route centered for auto-assist capture.',
};
