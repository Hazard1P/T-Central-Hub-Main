...
export const PLAYABLE_SECTION_VERSION = '2026.05.31-dyson-checkpoint-playable';
...
export function getPlayableSectionPolicy({ selectedSlug = null, identityScope = 'guest' } = {}) {
  ...
  return {
    ...
    checkpoint: {
      ...
      checkpointTypes: ['dyson-ring-integrity', 'private-map-anchor', 'playable-avatar-state', 'server-route-allowance'],
    },
    encryption: {
