const BASE_SERVER_DEFINITIONS = [
  {
    ...
    game: 'Arma 3',
    mode: 'CTH',
    modeDescription: 'Capture the Hill (CTH): two teams repeatedly contest and hold a central objective for points and control.',
    map: 'Altis',
    tier: 'Primary',
    maxPlayers: 60,
    steamAppId: '107410',
    ...
    family: 'arma',
    integration: {
      serverId: 'tcentral-arma3-cth-01',
      serverBuild: 'KOTH_REBUILD_V1',
      pboPackage: 'tcentral_koth_hub.pbo',
      pboMount: '@tcentral_kothhub/addons/tcentral_koth_hub.pbo',
      missionId: 'koth_altis_rebuild',
      missionVersion: '2026.04.23',
      accountStorage: 'player_progression',
      vipSystem: {
        enabled: true,
        tiers: ['supporter', 'elite', 'commander'],
      },
    },
  },
  {
    ...
    game: 'Rust',
    mode: 'Vanilla',
    modeDescription: 'Vanilla Rust with a bi-weekly wipe cadence focused on balanced progression and fresh map resets.',
    map: 'Procedural Map',
    tier: 'Primary',
    maxPlayers: 250,
  ...
  },
  {
    ...
    game: 'Rust',
    mode: 'Vanilla',
    modeDescription: 'Vanilla Rust with weekly wipes for rapid resets, fast onboarding, and frequent new starts.',
    map: 'Procedural Map',
    tier: 'Primary',
    maxPlayers: 250,
  ...
  },
  {
    ...
    game: 'Rust',
    mode: 'Vanilla',
    modeDescription: 'Vanilla Rust with monthly wipes designed for longer-term base progression and sustained rivalry arcs.',
    map: 'Procedural Map',
    tier: 'Primary',
    maxPlayers: 250,
  ...
  },
  {
    ...
    game: 'Rust',
    mode: 'Vanilla',
    modeDescription: 'Overview route for the Rust vanilla family, connecting players to the active wipe cadence routes.',
    map: 'Procedural Map',
    tier: 'Overview',
    maxPlayers: 250,
    wipeCadence: 'Bi-Weekly Wipe',
...
function enrichServerDefinition(server, index) {
  ...
  return {
    ...
    integration: server.integration || null,
  };
}
